...
if (newArray !== undefined && newArray.length > 0 && Array.isArray(newArray)) {
  ...
  console.log(
    incorrectMsg +
      "The initialized 'newArray' should be defined and have a length of more than 0, but yours looks like " +
      newArray,
  );
}
totalTests++;
...
if (isAnArray !== undefined && isAnArray === correctIsArray) {
  console.log(
    correctMsg +
      "As for the variable 'maybeAnArray' being an array, you found this was " +
      isAnArray,
  );
  passedTests++;
} else {
  console.log(
    incorrectMsg +
      "As for the variable 'maybeAnArray' being an array, this should be " +
      correctIsArray +
      ' but you got ' +
      isAnArray,
  );
...
if (
  JSON.stringify(array1) === JSON.stringify(correctArray1n2) &&
  ...
  console.log(array2);
  console.log(
    "Notice how 'array1' and 'array2' are identical as they were assigned BY REFERENCE",
  );
  console.log("Meanwhile 'array3' looks like:");
  console.log(array3);
  console.log(
    "Notice how it is its own array reference as it was assigned a DEEP COPY of 'array1'",
  );
  passedTests++;
} else {
...
if (
  growMe !== undefined &&
  JSON.stringify(growMe) === JSON.stringify(correctGrowArray)
) {
  console.log(
    correctMsg +
      'After adding "zero" to the beginning and "three" to the end of \'growMe\', \'growMe\' is:',
  );
  console.log(growMe);
  passedTests++;
} else {
  console.log(
    incorrectMsg +
      'After adding "zero" to the beginning and "three" to the end of \'growMe\', \'growMe\' should be:',
  );
...
if (
  shrinkMe !== undefined &&
  JSON.stringify(shrinkMe) === JSON.stringify(correctShrinkArray)
) {
  console.log(
    correctMsg +
      "After removing the first and last elements of 'shrinkMe', 'shrinkMe' is:",
  );
  ...
  console.log(
    incorrectMsg +
      "After removing the first and last elements of 'shrinkMe', 'shrinkMe' should be:",
  );
...
if (
  mergedLists !== undefined &&
  JSON.stringify(mergedLists) === JSON.stringify(correctMergedList)
) {
  console.log(
    correctMsg +
      "After concatenating 'marysList' and 'johnsList', 'mergedLists' is:",
  );
  ...
  console.log(
    incorrectMsg +
      "After concatenating 'marysList' and 'johnsList', 'mergedLists' should be:",
  );
...
if (arrayLength !== undefined && arrayLength === correctArrayLength) {
  ...
  console.log(
    "And number of elements in the 'getMyLength' array you got was: " +
      arrayLength,
  );
  passedTests++;
} else {
  ...
  console.log(getMyLength);
  console.log(
    "And the number of elements in the 'getMyLength' array should be " +
      correctArrayLength +
      ' but you got ' +
      arrayLength,
  );
...
if (arrayNthElement !== undefined && arrayNthElement === correctNthElement) {
  ...
  console.log(
    'Element number ' +
      nthElement +
      " in the 'getMyNthElement' array you got was: '" +
      arrayNthElement +
      "'",
  );
  passedTests++;
  ...
  console.log(
    'Element number ' +
      nthElement +
      " in the 'getMyNthElement' array should be '" +
      correctNthElement +
      "' but you got '" +
      arrayNthElement +
      "'",
...
if (
  ...
  JSON.stringify(arraySlice) === JSON.stringify(correctArraySlice)
) {
...
if (
  insertIntoMe !== undefined &&
  JSON.stringify(insertIntoMe) === JSON.stringify(correctInsertedArray)
) {
  console.log(
    correctMsg +
      'After inserting "that" and "was" elements into of \'insertIntoMe\', \'insertIntoMe\' looks like:',
  );
  ...
  console.log(
    incorrectMsg +
      'After inserting "that" and "was" elements into of \'insertIntoMe\', \'insertIntoMe\' should be:',
  );
...
if (
  removeFromMe !== undefined &&
  JSON.stringify(removeFromMe) === JSON.stringify(correctRemovedArray)
) {
  console.log(
    correctMsg +
      "After deleting elements from 'removeFromMe', 'removeFromMe' looks like:",
  );
  ...
  console.log(
    incorrectMsg +
      "After deleting elements from 'removeFromMe', 'removeFromMe' should be:",
  );
...
if (
  breakfastIncludesBacon !== undefined &&
  breakfastIncludesBacon === correctBreakfastIncludesBacon
) {
  console.log(
    correctMsg +
      'As for the variable \'breakfastList\' including "bacon", you found this was ' +
      breakfastIncludesBacon,
  );
  passedTests++;
} else {
  console.log(
    incorrectMsg +
      'As for the variable \'breakfastList\' including "bacon", this should be ' +
      correctBreakfastIncludesBacon +
      ' but you got ' +
      breakfastIncludesBacon,
  );
}
...
if (
  sortMe !== undefined &&
  JSON.stringify(sortMe) === JSON.stringify(sortMeCopy)
) {
  console.log(
    correctMsg + "After sorting the elements in 'sortMe', 'sortMe' looks like:",
  );
  console.log(sortMe);
  passedTests++;
} else {
  console.log(
    incorrectMsg +
      "After sorting the elements in 'sortMe', 'sortMe' should be:",
  );
...
if (
  sortAndReverseMe !== undefined &&
  JSON.stringify(sortAndReverseMe) === JSON.stringify(sortAndReverseMeCopy)
) {
  console.log(
    correctMsg +
      "After sorting and reversing the elements in 'sortAndReverseMe', 'sortAndReverseMe' looks like:",
  );
  ...
  console.log(
    incorrectMsg +
      "After sorting and reversing the elements in 'sortAndReverseMe', 'sortAndReverseMe' should be:",
  );
...
if (
  arrayFromSplitString !== undefined &&
  JSON.stringify(arrayFromSplitString) ===
    JSON.stringify(correctArrayFromSplitString)
) {
  console.log(
    correctMsg +
      "After splitting string 'splitMeIntoArray' into the array 'arrayFromSplitString', 'arrayFromSplitString' looks like:",
  );
  ...
  console.log(
    incorrectMsg +
      "After splitting string 'splitMeIntoArray' into the array 'arrayFromSplitString', 'arrayFromSplitString' should be:",
  );
...
if (
  stringFromJoinedArray !== undefined &&
  JSON.stringify(stringFromJoinedArray) ===
    JSON.stringify(correctStringFromJoinArray)
) {
  console.log(
    correctMsg +
      "After joining array 'joinMeIntoString' into the string 'stringFromJoinedArray', 'stringFromJoinedArray' looks like:",
  );
  ...
  console.log(
    incorrectMsg +
      "After joining array 'joinMeIntoString' into the string 'stringFromJoinedArray', 'stringFromJoinedArray' should be:",
  );
...
// Array Tic Tac Toc
let correctTicTacToeWinner =
  ticTacToeArray[0][0] === ticTacToeArray[1][1] &&
  ticTacToeArray[0][0] === ticTacToeArray[2][2] &&
  ticTacToeArray[0][0] !== '';
if (
  ticTacToeWinner !== undefined &&
  ticTacToeWinner === correctTicTacToeWinner
) {
  ...
  console.log(']');
  console.log(
    'And you said there being a diagonal winner was ' + ticTacToeWinner,
  );
  passedTests++;
} else {
  ...
  console.log(']');
  console.log(
    'And there being a diagonal winner should be ' +
      correctTicTacToeWinner +
      ' but you said ' +
      ticTacToeWinner,
  );
}
